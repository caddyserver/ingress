...
require (
	github.com/caddyserver/caddy/v2 v2.8.0-beta.1
...
require (
	...
	github.com/mholt/acmez/v2 v2.0.0-beta.2 // indirect
	...
	github.com/smallstep/certificates v0.25.3-rc5 // indirect
	...
	golang.org/x/crypto/x509roots/fallback v0.0.0-20240416174822-0da2a6a1bbc8 // indirect
