...
func (c *CaddyController) updateIngStatuses(controllerAddresses []apiv1.LoadBalancerIngress, ings []*networkingV1.Ingress) {
...
func runUpdate(logger *zap.SugaredLogger, ing *networkingV1.Ingress, status []apiv1.LoadBalancerIngress, client *kubernetes.Clientset) pool.WorkFunc {
